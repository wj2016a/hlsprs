...
/*The raw genetic sequencing data of CLHLS used in this study have been deposited and controlled at the CNGB Sequence Archive (CNSA, https://db.cngb.org/cnsa/) 
 of the China National GeneBank DataBase (CNGBdb) under accession code CNP0000792 (https://db.cngb.org/search/?q=CNP0000792). 
The raw genetic sequencing data used in this study are available under restricted access due to data privacy laws and ethical restrictions. 
Access can be obtained by completing the application form via https://db.cngb.org/data_access/ or 
by contacting the corresponding authors (shixm@chinacdc.cn or lvyuebin@nieh.chinacdc.cn), and will be answered within 10 weeks. 
The sharing requests for raw genetic sequencing data of CLHLS will be reviewed by the institutional ethical committees of CLHLS study to 
verify whether the request is subject to any intellectual property or confidentiality obligations. */
...
/*Step6:Integrated healthy lifestyle, genetic risk, and rate of cognitive decline;*/ 
...
/*Step7:The PROC MIXED Models among overall participants*/
...
/*Step8:Integrated healthy lifestyle, genetic risk, and risk of cognitive impairment;*/
